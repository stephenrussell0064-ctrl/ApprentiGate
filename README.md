...
**Current state: WP13 complete — every page is built, discoverable, and
verified.** Measurements are in [`QA-REPORT.md`](./QA-REPORT.md), regenerated by
`pnpm qa:report` rather than written by hand. Scaffold, quality gates, brand and design system, component
