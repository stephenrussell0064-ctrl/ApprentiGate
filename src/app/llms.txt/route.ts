...
export function GET(): Response {
  const lines = [
    ...
    '- Work ends at handover to the chosen provider. Ongoing programme administration,',
    "  review scheduling and off-the-job hours tracking are the training provider's",
    "  responsibility, not ApprentiGate's.",
    '',
    ...
    `- [How it works](${absoluteUrl(ROUTES.howItWorks)}): the six steps, and what each asks of the employer`,
    `- [For employers](${absoluteUrl(ROUTES.forEmployers)}): the five services, how providers are compared, and why a matching job title is not a matching standard`,
